...
```
git clone https://github.com/oshern7/node-chat-api.git
npm install
```
...
Instructions about running the container are available [here](https://github.com/oshern7/node-chat-api.git)
